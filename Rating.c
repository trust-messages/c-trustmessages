...
static asn_TYPE_member_t asn_MBR_Rating_1[] = {
	...
	{ ATF_OPEN_TYPE | ATF_NOFLAGS, 0, offsetof(struct Rating, value),
		-1 /* Ambiguous tag (ANY?) */,
		0,
		&asn_DEF_ANY,
		0,	/* Defer constraints checking to the member type */
...
static const asn_TYPE_tag2member_t asn_MAP_Rating_tag2el_1[] = {
    ...
    { (ASN_TAG_CLASS_UNIVERSAL | (19 << 2)), 0, 0, 2 }, /* source */
    { (ASN_TAG_CLASS_UNIVERSAL | (19 << 2)), 1, -1, 1 }, /* target */
    { (ASN_TAG_CLASS_UNIVERSAL | (19 << 2)), 2, -2, 0 } /* service */
};

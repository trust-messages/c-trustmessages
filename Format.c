...
int
Format_constraint(asn_TYPE_descriptor_t *td, const void *sptr,
 ...
 */
static void
Format_1_inherit_TYPE_descriptor(asn_TYPE_descriptor_t *td) {
...
void
Format_free(asn_TYPE_descriptor_t *td,
		void *struct_ptr, int contents_only) {
	Format_1_inherit_TYPE_descriptor(td);
	td->free_struct(td, struct_ptr, contents_only);
}

int
Format_print(asn_TYPE_descriptor_t *td, const void *struct_ptr,
...
asn_dec_rval_t
Format_decode_ber(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
Format_encode_der(asn_TYPE_descriptor_t *td,
...
asn_dec_rval_t
Format_decode_xer(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
Format_encode_xer(asn_TYPE_descriptor_t *td, void *structure,
...
asn_dec_rval_t
Format_decode_uper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
Format_encode_uper(asn_TYPE_descriptor_t *td,
...
static const ber_tlv_tag_t asn_DEF_Format_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (6 << 2))
};
asn_TYPE_descriptor_t asn_DEF_Format = {
	"Format",
	"Format",
	Format_free,
	Format_print,
	...
	asn_DEF_Format_tags_1,
	sizeof(asn_DEF_Format_tags_1)
		/sizeof(asn_DEF_Format_tags_1[0]), /* 1 */
	asn_DEF_Format_tags_1,	/* Same as above */
	sizeof(asn_DEF_Format_tags_1)
		/sizeof(asn_DEF_Format_tags_1[0]), /* 1 */
